...
const translations = {
  id: {
    ...
    ActivitySleepHoursTitle: "Jam Tidur (Sleep Hours)",
    ActivitySleepPlaceholder: "Contoh: 7.5",
    ActivityPhysicalActivityTitle: "Aktivitas Fisik (Menit)",
    ActivityPhysicalActivityPlaceholder: "Menit",
    ActivityStudyHoursTitle: "Jam Belajar (Study Hours)",
    ActivityHourPlaceholder: "Jam",
    ActivityScreenTimeTitle: "Screen Time (Jam)",
    ActivitySocialMediaTitle: "Penggunaan Media Sosial (Jam)",
    ActivityAssignmentLoadTitle: "Beban Tugas (Assignment Load)",
    ActivityDeadlinePressureTitle: "Tekanan Deadline",
    ActivityFatigueTitle: "Tingkat Kelelahan (Fatigue)",
    ActivityMoodTitle: "Skor Suasana Hati (Mood Score)",
    ...
    ActivityMediumStatus: "Sedang",
    ActivityHighStatus: "Tinggi",
    ...
    ActivityDeadlinePressureContributor: "Tekanan Deadline",
  ...
  en: {
    ...
    ActivityPhysicalActivityTitle: "Physical Activity (Minutes)",
    ActivityPhysicalActivityPlaceholder: "Minutes",
    ActivityStudyHoursTitle: "Study Hours",
    ActivityHourPlaceholder: "Hours",
    ...
    ActivityDeadlinePressureTitle: "Deadline Pressure",
    ActivityFatigueTitle: "Fatigue Level",
    ActivityMoodTitle: "Mood Score",
    ...
    ActivityMediumStatus: "Medium",
    ActivityHighStatus: "High",
    ...
    ActivityDeadlinePressureContributor: "Deadline Pressure",
